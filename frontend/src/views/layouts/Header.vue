          ...
          <mdb-navbar class="header-area primary-bg lighten-4" expand="xl" togglerIcon="" animated animation="1" style="margin: 0;">
            ...
            <mdb-navbar-toggler>
              <mdb-navbar-nav right>
                <mdb-nav-item router to="/" waves-fixed>{{ $t('header.101moo') }}</mdb-nav-item>
                <mdb-nav-item router to="/about" waves-fixed>{{ $t('header.about') }}</mdb-nav-item>
                ...
                <mdb-nav-item router to="/contact" waves-fixed>{{ $t('header.contact') }}</mdb-nav-item>
              </mdb-navbar-nav>
            </mdb-navbar-toggler>
